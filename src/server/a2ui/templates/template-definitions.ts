...
export const TEMPLATE_DEFINITIONS: A2UITemplateDef[] = [
  ...
  },
  {
    ...
    name: SEED_TEMPLATE_MAP["tpl_rollback_action"].name,
    description: SEED_TEMPLATE_MAP["tpl_rollback_action"].description,
    cardType: "rollback_action",
    requiredBindings: ["tpl_rollback_action.candidates"],
    optionalBindings: [],
    fallbackPolicy: { mode: "text_fallback" },
  },
  {
    id: "tpl_deployment_approval_inbox",
    name: SEED_TEMPLATE_MAP["tpl_deployment_approval_inbox"].name,
    description: SEED_TEMPLATE_MAP["tpl_deployment_approval_inbox"].description,
    cardType: "deployment_approval_inbox",
    requiredBindings: ["tpl_deployment_approval_inbox.requests"],
    optionalBindings: [],
    fallbackPolicy: { mode: "text_fallback" },
  },
  {
    id: "tpl_quick_deploy_launchpad",
    name: SEED_TEMPLATE_MAP["tpl_quick_deploy_launchpad"].name,
