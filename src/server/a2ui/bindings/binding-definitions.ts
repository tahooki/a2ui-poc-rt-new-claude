...
export const TEMPLATE_BINDINGS: TemplateBindingDef[] = [
  ...
  },
  {
    ...
    slot: "detail",
    sourceId: "deployment.quickPipelineBaseline",
    required: true,
    inputMapping: {
  ...
  {
    id: "tpl_quick_deploy_launchpad.artifact",
    templateId: "tpl_quick_deploy_launchpad",
    slot: "related",
    sourceId: "deployment.quickPipelineArtifact",
    required: false,
    inputMapping: {
      deploymentId: "$args.deploymentId",
      actorId: "$session.actorId",
  ...
  {
    id: "tpl_quick_deploy_launchpad.deployRun",
    templateId: "tpl_quick_deploy_launchpad",
    slot: "events",
    sourceId: "deployment.quickPipelineRun",
    required: false,
    inputMapping: {
      deploymentId: "$args.deploymentId",
      actorId: "$session.actorId",
  ...
  {
    id: "tpl_quick_deploy_launchpad.runEvents",
    templateId: "tpl_quick_deploy_launchpad",
    slot: "events",
    sourceId: "deployment.quickPipelineEvents",
    required: false,
    inputMapping: {
      deploymentId: "$args.deploymentId",
      actorId: "$session.actorId",
